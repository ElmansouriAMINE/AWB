...
class MarkerAttijariWafaInfoFragment : DialogFragment() {
    private var agence: AgenceAttijariWafaDto? = null

    private lateinit var binding : FragmentMarkerAttijariWafaInfoBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMarkerAttijariWafaInfoBinding.inflate(layoutInflater)
    ...
    private fun doShareAgenceInfos(agence: AgenceAttijariWafaDto) {
    ...
    private fun doCall(agence: AgenceAttijariWafaDto){
        agence?.let {
